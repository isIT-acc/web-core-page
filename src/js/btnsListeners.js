...
var requestCallCloseBtn = document.querySelector(".modal-screen--request-a-call .btn--close-icon");
var sendFeedbackCloseBtn = document.querySelector(".modal-screen--send-feedback .btn--close-icon");
